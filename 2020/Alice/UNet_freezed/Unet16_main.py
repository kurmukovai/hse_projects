...
layers = [0,1,3,4,7,8,10,11,14,15,17,18,20,21,24,25,27,28,30,31,34,35,37,38,40,41]
for i in layers:
...
for epoch in range(n_epochs):
    ...
    with torch.no_grad():
        ...
        np.save('/home/adkugusheva/unet_4/stats.npy', stats)

        if epoch_val_loss < val_loss_min:
            torch.save(model.state_dict(), '/home/adkugusheva/unet_4/model_'+str(epoch)+'.pt')
